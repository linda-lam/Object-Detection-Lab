...
gaussianF = fspecial('gaussian',[3 3], 0.5);
I = imfilter(I, gaussianF, 'replicate');
...
for i = 1:nori
  ...
  angleMin = -pi + (i-1)*2*pi/nori;
  angleMax = -pi + i*2*pi/nori;
  B = (mag > thresh & ori >= angleMin & ori <= angleMax);
